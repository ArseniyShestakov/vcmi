...
#endif
{
	...
	*console->cb = processCommand;
	...
	if(!testFile("DATA/HELP.TXT", "Heroes III data") || !testFile("MODS/VCMI/MOD.JSON", "VCMI data"))
	{
...
static void mainLoop()
{
	...
	resChanged([](const JsonNode & newState)
	{
		CGuiHandler::pushSDLEvent(SDL_USEREVENT, FULLSCREEN_TOGGLED);
	});
