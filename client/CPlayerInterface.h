...
public:
	...
	ObjectInstanceID nextTileTeleportId; //contain -1 or object id if teleportation
	...
	void showTeleportDialog(TeleportChannelID channel, const std::vector<ObjectInstanceID> exits, bool impassable, QueryID askID) override;
