...
void CStackWindow::CWindowSection::createCommanderAbilities()
{
	...
	auto leftBtn = new CButton(Point(10, pos.h + 6), "hsbtns3.def", CButton::tooltip(), [ = ] { list->moveToPrev();
				   }, SDLK_LEFT);
	auto rightBtn = new CButton(Point(411, pos.h + 6), "hsbtns5.def", CButton::tooltip(), [ = ] { list->moveToNext();
				    }, SDLK_RIGHT);
...
void CStackWindow::CWindowSection::createButtonPanel()
{
	...
	auto exitBtn = new CButton(Point(382, 5), "hsbtns.def", CGI->generaltexth->zelp[447], [ = ] { parent->close();
				   }, SDLK_RETURN);
