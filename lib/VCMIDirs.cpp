...
bfs::path IVCMIDirs::userSavePath() const
{
...
bfs::path VCMIDirsWIN32::oldUserSavePath() const
{
...
bfs::path VCMIDirsWIN32::clientPath() const
{
	return binaryPath() / "VCMI_client.exe";
}
bfs::path VCMIDirsWIN32::serverPath() const
{
	return binaryPath() / "VCMI_server.exe";
}

bfs::path VCMIDirsWIN32::libraryPath() const
{
	return ".";
}
bfs::path VCMIDirsWIN32::binaryPath() const
{
	return ".";
}
...
std::string VCMIDirsWIN32::libraryName(const std::string & basename) const
{
	return basename + ".dll";
}
...
bfs::path IVCMIDirsUNIX::serverPath() const
{
	return binaryPath() / "vcmiserver";
}
...
bfs::path VCMIDirsOSX::libraryPath() const
{
	return ".";
}
bfs::path VCMIDirsOSX::binaryPath() const
{
	return ".";
}

std::string VCMIDirsOSX::libraryName(const std::string & basename) const
{
...
std::string VCMIDirsXDG::libraryName(const std::string & basename) const
{
...
bfs::path VCMIDirsAndroid::libraryPath() const
{
	return nativePath;
}
bfs::path VCMIDirsAndroid::userDataPath() const
{
	return basePath;
}
bfs::path VCMIDirsAndroid::userCachePath() const
{
	return userDataPath() / "cache";
}
bfs::path VCMIDirsAndroid::userConfigPath() const
{
	return userDataPath() / "config";
}
