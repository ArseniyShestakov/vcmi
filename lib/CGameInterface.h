...
public:
	...
	{
	}; //called when interface has opportunity to use Tactics skill -> use cb->battleMakeTacticAction from this function
...
public:
	...
	{
	}; //called AFTER playerStartsTurn(player)
	...
	virtual void finish()
	{
	}; //if for some reason we want to end
