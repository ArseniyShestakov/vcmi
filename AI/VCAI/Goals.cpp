...
TSubgoal CollectRes::whatToDoToAchieve()
{
	...
	{
		return !(market->o->ID == Obj::TOWN && market->o->tempOwner == ai->playerID) && !ai->isAccessible(market->o->visitablePos());
	}), markets.end());
...
TGoalVec GatherArmy::getAllPossibleSubgoals()
{
	...
	{
		return (h == heroDummy.h || !ai->isAccessibleForHero(heroDummy->visitablePos(), h, true) || !ai->canGetArmy(heroDummy.h, h) || ai->getGoal(h)->goalType == Goals::GATHER_ARMY);
	});
